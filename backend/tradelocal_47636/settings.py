"""
Django settings for tradelocal_47636 project.
...
ROOT_URLCONF = 'tradelocal_47636.urls'
...
WSGI_APPLICATION = 'tradelocal_47636.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tradelocal_47636 API",
    "DESCRIPTION": "API documentation for tradelocal_47636 App",
    "VERSION": "v1",
}
